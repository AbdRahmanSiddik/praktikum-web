...
$query = mysqli_query($conn, "SELECT COUNT(*) as jumlah_data FROM data_jurusan");
$result = mysqli_fetch_assoc($query);

$mahasiwa = mysqli_query($conn,"SELECT COUNT(*) as jumlah_maha FROM data_mahasiswa");
$mhs = mysqli_fetch_array($mahasiwa);

$admin = mysqli_query($conn, "SELECT COUNT(*) as akses FROM operator");
$akses=mysqli_fetch_array($admin);

$total = mysqli_query($conn, "SELECT
(SELECT COUNT(jenis_kelamin) FROM data_mahasiswa WHERE jenis_kelamin = 'L') as total_lk,
(SELECT COUNT(jenis_kelamin) FROM data_mahasiswa WHERE jenis_kelamin = 'P') as total_pr");
while ($jumlah = mysqli_fetch_array($total)) {
  $lk_lk = $jumlah['total_lk'];
  $perempuan = $jumlah['total_pr'];
}

$totalPerJurusan = mysqli_query($conn, "SELECT j.id_jurusan, j.nama_jurusan, COUNT(m.id_mahasiswa) as jumlah_mahasiswa
                            FROM data_jurusan j
              ...
              <div class="card-body">
                <div class="media align-items-center">
                  ...
                  <div class="media-body">
                    ...
                    <span class="title text-black font-w600"><?= $result['jumlah_data']; ?></span>
                  </div>
                </div>
              ...
              <div class="card-body">
                <div class="media align-items-center">
                  ...
                  <div class="media-body">
                    ...
                    <span class="title text-black font-w600"><?= $akses['akses']; ?></span>
                  </div>
                </div>
                <div class="progress" style="height:5px;">
              ...
              <div class="card-body">
                <div class="media align-items-center">
                  ...
                  <div class="media-body">
                    ...
                    <span class="title text-black font-w600"><?= $lk_lk; ?>/<?= $perempuan; ?></span>
                  </div>
                </div>
                <div class="progress" style="height:5px;">
              ...
              <div class="card-body">
                <div class="media align-items-center">
                  ...
                  <div class="media-body">
                    ...
                    <span class="title text-black font-w600"><?= $mhs['jumlah_maha']; ?></span>
                  </div>
                </div>
                <div class="progress" style="height:5px;">
          ...
          <div class="col-12">
            <div class="table-responsive">
              <table class="table table-bordered">
                ...
                <tbody>
                  <?php foreach($totalPerJurusan as $data): ?>
                  <tr>
          ...
          <div class="col-lg-12">
            <div class="card bg-gra" style=" box-shadow: 0 1px 8px rgb(153 153 153 / 20%), 0 3px 4px rgb(255 255 255 / 14%), 0 3px 3px -2px rgb(255 255 255 / 12%);">
              <div class="card-body">
                ...
                <div class="mt-4">
                  <h5 class="mb-0" style="color: #008eff">Selamat Datang, <?= $_SESSION['nama_operator']; ?></h5>
                </div>
              </div>
            </div>
          </div>
